...
- **验收改为双网页自测**：独自开发时用两个浏览器标签/窗口（不同昵称进同一房间）互测即可；真人 30 分钟会仍建议有机会时补做
...
| 3   | 2026-07-28 |            |      | 功能项已落地；**验收改为双网页自测**（两标签不同昵称同房） |
| 4   |            |            |      |                                                                            |
| 5   |            |            |      |                                                                            |
| 6   |            |            |      |                                                                            |
